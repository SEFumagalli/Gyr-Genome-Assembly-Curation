...
#totXCov = totSum / 3000000000
intXCov = intSum / 3000000000
...
print("ReadsGt100kbNum\tReadsGt100kbBases\tReadsGt100kbXcov(cattle)")
print("\t".join([str(x) for x in [intLen,intSum,intXCov]]))
